# Archived NEXT_SESSION_PROMPT paste-block (superseded 2026-08-16)

Superseded by the lean block in `docs/NEXT_SESSION_PROMPT.md`. Kept in full because
deleting a 555-line briefing wholesale is how a load-bearing warning gets lost - the
very incident that produced the 40-line cap. Nothing here is current; read the live
prompt first and treat this as history.
