...
Don't take the demos on faith - run it yourself. CI runs both `run_selftests.py` and the
integration test below on Linux, macOS and Windows:
...
ship-bar: OK  gate-ledger: OK  false-alarm-scorer: OK  python-floor: OK
skill-deps: OK  review-freshness-scope: OK  readme-fresh: OK  no-regression: OK
hook-provenance: OK  mutation-anchors: OK  corpus-scorer: OK
all 36 selftests passed
